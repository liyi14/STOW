...
class HungarianMatcher(nn.Module):
    ...
    def __init__(self, cost_class: float = 1, 
        ...
        assert cost_class != 0 or cost_mask != 0 or cost_dice != 0 or cost_reid != 0, "all costs cant be 0"
    ...
    def memory_efficient_forward(self, outputs, targets):
        ...
        for b in range(bs):
            ...
            with autocast(enabled=False):
                ...
                if 'track_reid' in targets[b] and 'pred_reid' in outputs and len(targets[b]['track_reid']) > 0:
                    cost_reid = batch_reid_loss_jit(outputs["pred_reid"][b], 
                                                    targets[b]["track_reid"], 
                                                    targets[b]['gt_matched_track_indices'])
                    cost_inv_reid = batch_inv_reid_loss_jit(outputs["pred_reid"][b],
                                                    targets[b]["track_reid"], 
                                                    targets[b]['gt_matched_track_indices'])
                else:
                    cost_reid = 0
    ...
    def __repr__(self, _repr_indent=4):
        ...
        body = [
            ...
            "cost_reid: {}".format(self.cost_reid),
            "cost_inv_reid: {}".format(self.cost_inv_reid),
        ]
